...
First is the exploratory analysis.  Here, we pull in the mean and standard deviation for each of the exploratory variables.
...
Finally, we can evaluate the model and its residuals.
We observe that the second model is a better fit because it has lower residuals (11,414.37 vs. 13,676.84).  
