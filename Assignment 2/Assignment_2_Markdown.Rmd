...
hist(shp@data$PCTBACHMOR, breaks = 40, col = "#e28743",
     main = "Percent of Population with
...
hist(shp@data$Log_PCTVACANT, breaks = 40,col = "#e28743",
     main = "Log Transformation of the
     Percent Units marked as Vacant",
     xlab = "Log_PCTVACANT")
hist(shp@data$Log_PCTSINGLES, breaks = 40, col = "#e28743",
     main = "Log Transformation of the
     Percent of Units Marked as Single Family",
     xlab = "Log_PCTSINGLES")
...
hist(shp@data$Log_NBelPov100, breaks = 50,col = "#e28743",
     main = "Log Transformation of the
     Number of Households Below Povery",
     xlab = "Log_NBelPov100")
...
moranMC<-moran.mc(shp$Log_MEDHHINC, queenlist, nsim=999, alternative="two.sided")  #We use 999 permutations
moranMC
...
moran.plot(shp$Log_MEDHHINC, queenlist, xlab = "Log_MEDHHINC") 
```
...
#1.h  CHECK BELOW 1.i - IS THIS CORRECT? (MIXED UP SPATIAL LAG AND SPATIAL ERROR) + ADD MAP
